...
infusion_choice = "uncommon : " + infusion
...
if alev < 10:
	if not loan:
		err("Character cannot make uncommon Replications. If this is a loan Replication use `-l artificerlevel` to specify a loan and which level artificer it is from")
	else:
